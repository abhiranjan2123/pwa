...
function Component() {
          ...
          >
            <CardContent>
              ...
              >
                ...
                <ListItemText primary="quantity" secondary={item.qty}/>
              </ListItem>
            </CardContent>
          </Card>
        ))}
  ...
  return (
    <Box  sx={{ width: "95vw" }}>
      ...
      >
        <Grid item>
          <Typography variant="h2" fontFamily="mistral">Cloth-Items</Typography>
        </Grid>
        <Grid item>
          <Button onClick={handleAddItemFormOpen} color="success"><PersonAddIcon /></Button>
