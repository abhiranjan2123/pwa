...
function Component() {
  ...
  const AddWorkerModal = () => {
    ...
    async function handleAddWorkerSubmit(e) {
      ...
      console.log("Add worker", { name, age, gender,phone });
    ...
    return (
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h5" component="h5" fontFamily="mistral">
            Add Worker
          </Typography>
              ...
              <ListItem
                ...
                secondaryAction={
                  <React.Fragment>
                    ...
                    >
                      <PersonRemoveIcon color="success"/>
                    </IconButton>
                  </React.Fragment>
                }
              >
                ...
                <ListItemText primary={worker.name} secondary={worker.phone} />
                <ListItemText primary="Age" secondary={worker.age}/>
              </ListItem>
            </CardContent>
          </Card>
        ))}
  ...
  return (
    <Box sx={{ width: "95vw" }}>
      ...
      >
        <Grid item>
          <Typography variant="h2" fontFamily="mistral">Workers</Typography>
        </Grid>
        <Grid item>
          <Button onClick={handleAddWorkerFormOpen} color="success"><PersonAddIcon/></Button>
