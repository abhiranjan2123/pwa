...
function Component() {
  ...
  const AddCustomerModal = () => {
    ...
    return (
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h5" component="h5" color="green" fontFamily="mistral" fontSize={50}>
            Add Customer
          </Typography>
  ...
  return (
    <Box sx={{ width: "95vw" }}>
      ...
      >
        <Grid item >
          <Typography variant="h2" fontFamily="mistral">Customers</Typography>
        </Grid>
        <Grid item>
          <Button onClick={handleAddCustomerFormOpen} color="success"><PersonAddIcon /></Button>
